...
public class pidul_meu extends OpMode {
    ...
    double max = 0;
    double pmotorBL,pmotor2BL;
    double pmotorBR,pmotor2BR;
    double pmotorFL,pmotor2FL;
    double pmotorFR,pmotor2FR;
    double sm = 1;
    boolean bum = true;
    ...
    private final Thread Sensors = new Thread(new Runnable(){
        ...
        public void run() {
            while(!stop){
                ...
                if(distL.getDistance(DistanceUnit.CM) < 15||distB.getDistance(DistanceUnit.CM) < 15 || distR.getDistance(DistanceUnit.CM) < 15||distF.getDistance(DistanceUnit.CM) < 15) {
                    pmotor2BL = -pmotorBL;
                    pmotor2BR = -pmotorBR;
                    pmotor2FL = -pmotorFL;
                    pmotor2FR = -pmotorFR;
