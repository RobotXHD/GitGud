...
@Autonomous
public class SimpluAlbastru extends LinearOpMode {
    ...
    public Thread Autonom = new Thread(new Runnable(){
        ...
        public void run() {
            if (varrez == "Dreapta" && !isStopRequested()) {
                ...
                Translatare(-160, 0, 0.75);
                Translatare(0, 200, 0.75);
                lastTime = System.currentTimeMillis();
                while (lastTime + 100 > System.currentTimeMillis()) {
                }
                Translatare(140, 0, 0.75);
                */
                ...
                Translatare(-160, 0, 0.55);
                Translatare(0, 230, 0.75);
                lastTime = System.currentTimeMillis();
                while (lastTime + 100 > System.currentTimeMillis()) {
                }
