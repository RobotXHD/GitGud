...
@Autonomous
public class Autonom_pe_albastru extends LinearOpMode {
    ...
    public Thread Autonom = new Thread(new Runnable(){
        ...
        public void run() {
            if(varrez=="Dreapta"&&!isStopRequested()) {
                ...
                while(lastTime + 5000 > System.currentTimeMillis()){
                }
                ...
                Translatare(-145, 0, 0.75);
                Translatare(0, 350, 0.65);
            ...
            if(varrez == "Stanga"&&!isStopRequested())
            {
                ...
                */
                ...
                Translatare(0, 200, 0.6);
                Rotire(220, 0.5);
                Translatare(0, 25, 0.6);
                ...
                Translatare(0, -140, 0.7);
                lastTime = System.currentTimeMillis();
                while(lastTime + 200 > System.currentTimeMillis()){}

                Translatare(0, 10, 0.7);
                lastTime = System.currentTimeMillis();
                while(lastTime + 200 > System.currentTimeMillis()){}

                Rotire(10, 0.5);

                arm.setTargetPosition(0);//465
                arm.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                arm.setPower(1);
                while(arm.isBusy());
                arm.setPower(0);
                ...
                Translatare(0, 300, 0.8);
                lastTime = System.currentTimeMillis();
                while(lastTime + 200 > System.currentTimeMillis()){}

                Translatare(-60, 0, 0.8);
                lastTime = System.currentTimeMillis();
                while(lastTime + 200 > System.currentTimeMillis()){}

                Translatare(0, 220, 0.8);
