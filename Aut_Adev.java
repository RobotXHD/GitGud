...
public class Aut_Adev extends LinearOpMode {
    ...
    public Thread Autonom = new Thread(new Runnable(){
        @Override
        public void run() {
            //0=rotire in fata la stanga 1=rotire in spate la stanga 2=rotire in fata la dreapta 3=rotire in spate la dreapta
            Chestie(10000,1, 0);
        }
    });
    ...
    public void Chestie(int poz, double power, int choice){
        if(choice%4==0) {
